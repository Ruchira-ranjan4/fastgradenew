...
//   wp_enqueue_style('main', get_stylesheet_directory_uri() . '/css/main.css', array('parent-style'), $modified_bootscoreChildCss);
 ...
 // This theme uses wp_nav_menu() in one location.
        register_nav_menus( array(
            'student-dashboard-menu' => esc_html__( 'Student dashboard Menu', 'Student dashboard Menu' ),
		    'tutoringrequest-menu' => esc_html__( 'Tutoring Request Menu', 'Tutoring Request Menu' ),
			'tutor-profiles-menu' => esc_html__( 'Tutor Profiles Menu', 'Tutoring Request Menu' ),
