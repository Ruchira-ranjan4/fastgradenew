                    ...
                    <div class="row align-items-center">
                        <div class="col-md-9">
                            <div class="left-lg-bef">
                                <img class="w-100"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/f-lgbef.png">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="right-logo">
                                <img class="w-100"
                                    src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/f-logo.png">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="f-grd">
                                ...
                                <ul class="contsec">
                                    <li>
                                        <img
                                            src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/location.png">
                                        <p>3 Chalfont Rd,Etobicoke,<br> Ontario,Canada</p>
                                    </li>
                                    <li>
                                        <img
                                            src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/phone.png">
                                        <a href="#">613-293-7181</a>
                                    </li>
                                    <li>
                                        <img
                                            src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/email.png">
